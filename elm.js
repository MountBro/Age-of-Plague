...
var $author$project$Model$Polar = {$: 'Polar'};
...
var $author$project$Card$compulsoryMR = A5(
	$author$project$Card$Card,
	$author$project$Card$NoSel,
	6,
	_List_fromArray(
...
var $author$project$Card$enhancedHealing = A5(
	$author$project$Card$Card,
	$author$project$Card$NoSel,
	4,
	_List_fromArray(
...
var $author$project$Card$hospital = A5(
	...
	'Hospital',
	'Build hospital.');
var $author$project$Card$firstAid = A5(
	$author$project$Card$Card,
	$author$project$Card$NoSel,
	2,
	_List_fromArray(
...
var $author$project$Card$lowSoundWave = A5(
	$author$project$Card$Card,
	$author$project$Card$TileSel,
	4,
	_List_fromArray(
	...
	'Low Sound Wave',
	'Evacuate the tile.');
var $author$project$Card$medMob = A5(
	$author$project$Card$Card,
	$author$project$Card$NoSel,
	6,
	_List_fromArray(
...
var $author$project$Virus$virus = _List_fromArray(
	[$author$project$Virus$virus1, $author$project$Virus$virus2, $author$project$Virus$virus3]);
...
var $author$project$Model$map1 = A2(
	...
	return _Utils_Tuple2(
		{
			...
			city: A2($author$project$Tile$initCity, 20, $author$project$Model$map1),
			counter: 3,
			currentLevel: 1,
			currentRound: 1,
			...
			theme: $author$project$Model$Polar,
			todo: _List_Nil,
...
var $author$project$Model$map = _List_fromArray(
	[
		A2(
		$author$project$Geometry$cartesianProduct,
		_List_fromArray(
...
var $author$project$NextRound$ecoInc = function (model) {
	return _Utils_update(
		model,
...
var $author$project$NextRound$judgeWin = function (model) {
	return ((model.currentLevel === 1) && (model.currentRound === 4)) ? _Utils_update(
		model,
		{state: $author$project$Model$Finished}) : (((model.currentLevel === 2) && ((model.currentRound >= 4) && $elm$core$List$isEmpty(model.virus.pos))) ? _Utils_update(
		model,
		{state: $author$project$Model$Finished}) : (((model.currentRound === 21) && ((model.currentLevel > 2) && ($author$project$Tile$sumDead(model.city) < 80))) ? _Utils_update(
		model,
		{state: $author$project$Model$Finished}) : ((model.currentRound < 21) ? model : _Utils_update(
		model,
...
var $author$project$NextRound$powerInc = function (model) {
	return _Utils_update(
		model,
		{power: model.power + $author$project$Parameters$para.basicPowerInc});
};
...
var $author$project$NextRound$horrify = function (model) {
	...
	return (_Utils_cmp(
		...
		$author$project$Tile$sumPopulation(city)) > -1) ? _Utils_update(
		model,
		{flowrate: 2}) : _Utils_update(
		model,
		{flowrate: 1});
};
var $author$project$NextRound$mutate = F2(
	function (rule, model) {
		...
		var vir = (model.currentRound === 10) ? _Utils_update(
			vir_,
			{rules: rule}) : vir_;
		return _Utils_update(
			model,
		...
		if ((_Utils_cmp(
			...
			var virus = _Utils_update(
				virus_,
				{
					...
					kill: A2($elm$core$Basics$min, virus_.kill * 1.1, 0.6)
				});
			return _Utils_update(
				model,
				{counter: 3, virus: virus});
		} else {
			if (_Utils_cmp(
				size,
...
var $author$project$NextRound$takeOver = function (model) {
	...
	var tilelst = A2(
		...
		A2(
			$elm$core$List$filter,
			function (x) {
				return (_Utils_cmp((x.population - x.sick) * 3, x.dead) < 1) && (model.currentRound === 16);
			},
			city.tilesIndex));
...
var $author$project$NextRound$unBlockable = function (model) {
	...
	var actionDescribe = (!num) ? _Utils_ap(model.actionDescribe, _List_Nil) : ((num === 1) ? _Utils_ap(
		...
		model.actionDescribe) : _Utils_ap(_List_Nil, model.actionDescribe));
	return _Utils_update(
		model,
...
var $author$project$Population$populationFlow = F3(
	function (n, num, city) {
		populationFlow:
		while (true) {
			...
			var leaveLst = t.peoFlow ? A2(
				...
				A2(
					$elm$core$List$take,
					$elm$core$Basics$round(t.population / 2),
					A2(
						$elm$core$List$map,
						function (x) {
							return x.indice;
						...
						A2(
							$elm$core$List$sortBy,
							function (x) {
								return x.hos ? (x.sick + x.dead) : (x.sick + (x.dead * 2));
							},
							lstnTile)))) : _List_Nil;
			var sickleave = (_Utils_cmp(t.population, numNeig * num) > 0) ? $elm$core$Basics$round(((t.sick * numNeig) * num) / t.population) : t.sick;
			var mixLst = A2(
				$elm$core$List$take,
				A2($elm$core$Basics$modBy, num, sickleave),
				A2(
					$elm$core$List$drop,
					$elm$core$Basics$floor(sickleave / num),
					leaveLst));
			var sickLst = A2(
				$elm$core$List$take,
				$elm$core$Basics$floor(sickleave / num),
			...
			if (_Utils_cmp(
				...
				var newcitytileslst = ((_Utils_cmp(t.population, numNeig * num) > -1) && t.peoFlow) ? A2(
					$elm$core$List$map,
					function (x) {
						return _Utils_eq(x, t) ? _Utils_update(
							x,
							{population: x.population - (numNeig * num), sick: x.sick - sickleave}) : (A2($elm$core$List$member, x.indice, sickLst) ? _Utils_update(
							x,
							{population: x.population + num, sick: x.sick + num}) : (A2($elm$core$List$member, x.indice, mixLst) ? _Utils_update(
							x,
							{population: x.population + num, sick: x.sick + 1}) : (A2($elm$core$List$member, x.indice, leaveLst) ? _Utils_update(
							x,
							{population: x.population + num}) : x)));
					},
...
var $author$project$Population$virusKill = F2(
	function (vir, city) {
		...
		var estimateDeath = $elm$core$Basics$round(
			$elm$core$List$sum(
				A2(
					$elm$core$List$map,
					function (x) {
					...
					lstInfectedn)) * dr);
		var deathlst = (_Utils_cmp(death, estimateDeath) < 0) ? A2(
			$elm$core$List$take,
			A2(
				$elm$core$Basics$max,
				$elm$core$Basics$round((0.2 * death) / estimateDeath) * $elm$core$List$length(lstInfectedn),
				1),
			...
			A2(
				...
				A2(
					$elm$core$Basics$max,
					$elm$core$Basics$round((death - estimateDeath) * 0.2),
					1),
				lstInfected1));
		return _Utils_update(
			city,
			{
				tilesIndex: A2(
					$elm$core$List$map,
					function (x) {
						return (A2($elm$core$List$member, x, deathlst) && (dr > 0)) ? _Utils_update(
							x,
							{
								dead: x.dead + A2(
									$elm$core$Basics$max,
...
var $author$project$Population$updateCity = function (model) {
	var vir = model.virus;
	var num = model.flowrate;
	var city = model.city;
	return A3(
		$author$project$Population$populationFlow,
		1,
		num,
		A2(
			$author$project$Population$virusKill,
			vir,
			A2($author$project$Population$infect, city, vir)));
};
var $author$project$NextRound$virusEvolve = function (model) {
	...
	return A2(
		...
		$author$project$NextRound$unBlockable(
			$author$project$NextRound$horrify(
				A2(
					...
					$author$project$NextRound$takeOver(
						_Utils_update(
							model,
							{
								av: A3($author$project$Population$change, model.virus, model.av, model.city).b,
								city: $author$project$Population$updateCity(model),
								virus: A3($author$project$Population$change, model.virus, model.av, model.city).a
							}))))));
};
	...
	return (model.currentLevel === 1) ? (((model.currentRound === 1) && _Utils_eq(model.hands, _List_Nil)) ? _Utils_Tuple2(
		...
		$author$project$NextRound$clearCurrentRoundTodo(
			$author$project$Model$initlog(
				_Utils_update(
					model,
					{currentRound: 3, economy: 6, power: 1}))),
		...
		$author$project$Model$initlog(
			$author$project$NextRound$powerInc(
				$author$project$NextRound$ecoInc(
...
var $author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'DrawACard':
				return ((model.currentLevel === 1) && (_Utils_cmp($author$project$Parameters$para.ecoThreshold, model.economy) < 1)) ? (((model.currentRound === 3) && _Utils_eq(model.todo, _List_Nil)) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{economy: model.economy - $author$project$Parameters$para.ecoThreshold}),
					A2($elm$random$Random$generate, $author$project$Message$DrawCard, $author$project$Card$cardGenerator)) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none)) : (((model.currentLevel === 2) && (model.currentRound <= 4)) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : ((_Utils_cmp($author$project$Parameters$para.ecoThreshold, model.economy) < 1) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{economy: model.economy - $author$project$Parameters$para.ecoThreshold}),
					A2($elm$random$Random$generate, $author$project$Message$DrawCard, $author$project$Card$cardGenerator)) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none)));
			case 'DrawCard':
				var c = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'PlayCard':
				var card = msg.a;
				return (_Utils_cmp(card.cost, model.power) < 1) ? (A2($elm$core$List$member, card, $author$project$Card$targetCardlst) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var $author$project$View$bkg = function (t) {
	var color = function () {
		if (t.$ === 'Minimum') {
			return '#b0deb9';
		} else {
...
var $author$project$GameView$caption = F5(
				...
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$x(
							$elm$core$String$fromFloat(x)),
							$elm$svg$Svg$Attributes$xlinkHref('./assets/guide/SkeletonHand.png'),
							$elm$svg$Svg$Attributes$y(
							$elm$core$String$fromFloat(y)),
...
var $author$project$SvgSrc$hand2FirstCard = A3($author$project$SvgSrc$skeletonHand, 260.0, 15.0, 100.0);
				...
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$x(
							$elm$core$String$fromFloat(x)),
							$elm$svg$Svg$Attributes$xlinkHref('./assets/guide/RevSkeletonHand.png'),
							$elm$svg$Svg$Attributes$y(
							$elm$core$String$fromFloat(y)),
							$elm$svg$Svg$Attributes$width(
							$elm$core$String$fromFloat(width))
...
var $author$project$SvgSrc$hand2NextRound = A3($author$project$SvgSrc$revSkeletonHand, 250.0, 480.0, 100.0);
...
var $author$project$GameView$onClick = function (message) {
	return A2(
...
var $author$project$GameView$nextRoundButton = function (model) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$author$project$GameView$onClick($author$project$Message$NextRound)
			]),
		_List_fromArray(
			[
...
var $author$project$GameView$powerInfo = function (model) {
	return A5(
		$author$project$GameView$caption,
		($author$project$Parameters$para.xlp + $author$project$Parameters$para.wlp) + 50.0,
		$author$project$Parameters$para.ylp + 50.0,
		'orange',
...
var $author$project$GameView$renderConsole = function (model) {
	var lstr = A3(
		...
		_List_Nil,
		A2($elm$core$List$map, $elm$core$String$lines, model.actionDescribe));
	var l = $elm$core$List$length(model.actionDescribe);
	return A2(
		$elm$core$List$map,
		function (_v1) {
			var x = _v1.a;
			var y = _v1.b;
			var str = _v1.c;
			return A5($author$project$GameView$caption, x, y, 'white', str, 15);
		},
		A2(
			$elm$core$List$map,
			function (_v0) {
				var n = _v0.a;
				var str = _v0.b;
				return _Utils_Tuple3($author$project$Parameters$para.clp, $author$project$Parameters$para.conbot - ($author$project$Parameters$para.clh * ((l - 1) - n)), str);
			},
			A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, lstr)));
};
...
var $author$project$GameView$renderEconomyProgress = function (model) {
	var txt = $elm$core$String$fromInt(model.economy) + ('/' + $elm$core$String$fromInt($author$project$Parameters$para.ecoThreshold));
	var rotArg = 'rotate(-90,' + ($elm$core$String$fromFloat($author$project$Parameters$para.repx) + (',' + ($elm$core$String$fromFloat($author$project$Parameters$para.repy) + ')')));
	var eco = model.economy;
	var ratio = A2(
		$elm$core$Basics$max,
		0,
		A2($elm$core$Basics$min, 1, eco / $author$project$Parameters$para.ecoThreshold));
	var offSet = ((2.0 * $elm$core$Basics$pi) * $author$project$Parameters$para.repr) * ratio;
	var offSetComp = ((2.0 * $elm$core$Basics$pi) * $author$project$Parameters$para.repr) * (1.0 - ratio);
	var arr = $elm$core$String$fromFloat(offSet) + (' ' + $elm$core$String$fromFloat(offSetComp));
	return A2(
		$elm$svg$Svg$svg,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$stroke($author$project$Parameters$para.dcsc),
						$elm$svg$Svg$Attributes$strokeWidth('4'),
						$elm$svg$Svg$Attributes$fill('transparent'),
						$elm$svg$Svg$Attributes$strokeDasharray(arr),
						$elm$svg$Svg$Attributes$r(
						$elm$core$String$fromFloat($author$project$Parameters$para.repr)),
						$elm$svg$Svg$Attributes$cx(
						$elm$core$String$fromFloat($author$project$Parameters$para.repx)),
						$elm$svg$Svg$Attributes$cy(
						$elm$core$String$fromFloat($author$project$Parameters$para.repy)),
						$elm$svg$Svg$Attributes$transform(rotArg)
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$svg,
				_List_fromArray(
					[
						$author$project$GameView$onClick($author$project$Message$DrawACard)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								(_Utils_cmp(eco, $author$project$Parameters$para.ecoThreshold) < 0) ? 'red' : 'cyan'),
				...
				A5($author$project$GameView$caption, $author$project$Parameters$para.repx - 22.0, $author$project$Parameters$para.repy + 3.0, 'white', 'draw', 20),
				A5($author$project$GameView$caption, $author$project$Parameters$para.repx - 10.0, $author$project$Parameters$para.repy + 15.0, 'white', txt, 10)
			]));
};
...
var $author$project$GameView$renderFlag = function (i) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$fill($author$project$Parameters$para.gbc),
						$elm$svg$Svg$Attributes$x(
						$elm$core$String$fromFloat($author$project$Parameters$para.clp + 230.0)),
						$elm$svg$Svg$Attributes$y(
						$elm$core$String$fromFloat($author$project$Parameters$para.conbot - 40.0)),
						$elm$svg$Svg$Attributes$rx('5'),
						$elm$svg$Svg$Attributes$strokeWidth('2'),
						$elm$svg$Svg$Attributes$stroke($author$project$Parameters$para.gbsc),
	...
	return ((model.currentLevel === 1) || (model.currentLevel === 2)) ? A2(
		...
		A2(
			...
			function (_v1) {
				...
				var y = _v1.b;
				var str = _v1.c;
				return A5($author$project$GameView$caption, x + 250.0, y - 20, 'black', str, 16);
			},
			A2(
				$elm$core$List$map,
				function (_v0) {
					var n = _v0.a;
					var str = _v0.b;
					return _Utils_Tuple3($author$project$Parameters$para.clp, $author$project$Parameters$para.conbot + ($author$project$Parameters$para.clh * n), str);
				},
...
var $author$project$GameView$renderCard = F5(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil),
					A5($author$project$GameView$caption, x + 10.0, y + 10.0, 'white', c.name, 10)
				]));
	});
...
var $author$project$GameView$onOver = function (message) {
	return A2(
		$elm$html$Html$Events$on,
		'mouseover',
		$elm$json$Json$Decode$succeed(message));
};
var $author$project$GameView$renderCardFilm = F6(
	function (width, n, x, y, c, model) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$GameView$onClick(
					$author$project$Message$PlayCard(c)),
					$author$project$GameView$onOver(
...
var $author$project$GameView$renderCardPng = F4(
...
var $author$project$GameView$renderHands = function (model) {
	...
	var indexed = A2(
		...
		function (_v6) {
			...
			return _Utils_Tuple3(
				n,
				_Utils_Tuple2((($author$project$Parameters$para.xlp + $author$project$Parameters$para.wlp) + 150.0) + (($author$project$Parameters$para.hcw + $author$project$Parameters$para.hcg) * n), $author$project$Parameters$para.hctm),
				c);
		},
	...
	return _Utils_ap(
		A2(
			...
			function (_v0) {
				...
				var y = _v1.b;
				var c = _v0.c;
				return A5($author$project$GameView$renderCard, $author$project$Parameters$para.hcw, n, x, y, c);
			},
			indexed),
		_Utils_ap(
			A2(
				...
				function (_v2) {
					...
					var y = _v3.b;
					var c = _v2.c;
					return A4($author$project$GameView$renderCardPng, $author$project$Parameters$para.hcw, x, y, c);
				},
				indexed),
			A2(
				$elm$core$List$map,
				function (_v4) {
					...
					var y = _v5.b;
					var c = _v4.c;
					return A6($author$project$GameView$renderCardFilm, $author$project$Parameters$para.hcw, n, x, y, c, model);
				},
				indexed)));
};
...
var $author$project$GameView$renderInitCardFilm = F6(
	function (width, n, x, y, c, model) {
...
var $author$project$GameView$renderInitCards = function (model) {
	var hands = A2($elm$core$List$sortWith, $author$project$Card$cardComparison, model.hands);
	var indexed = A2(
		$elm$core$List$map,
		function (_v6) {
	...
	return _Utils_ap(
		A2(
			...
			function (_v0) {
				...
				var y = _v1.b;
				var c = _v0.c;
				return A5($author$project$GameView$renderCard, $author$project$Parameters$para.icw, n, x, y, c);
			},
			indexed),
		_Utils_ap(
			A2(
				...
				function (_v2) {
					...
					var y = _v3.b;
					var c = _v2.c;
					return A4($author$project$GameView$renderCardPng, $author$project$Parameters$para.icw, x, y, c);
				},
				indexed),
			A2(
				$elm$core$List$map,
				function (_v4) {
					...
					var y = _v5.b;
					var c = _v4.c;
					return A6($author$project$GameView$renderInitCardFilm, $author$project$Parameters$para.icw, n, x, y, c, model);
				},
				indexed)));
};
...
var $author$project$GameView$renderNextRound = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
			$author$project$GameView$onClick($author$project$Message$NextRound)
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromFloat($author$project$Parameters$para.repx - $author$project$Parameters$para.repr)),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromFloat($author$project$Parameters$para.repy - $author$project$Parameters$para.repr)),
					$elm$svg$Svg$Attributes$rx(
					$elm$core$String$fromFloat($author$project$Parameters$para.repr)),
					$elm$svg$Svg$Attributes$fill($author$project$Parameters$para.nrbc),
					$elm$svg$Svg$Attributes$width(
					$elm$core$String$fromFloat(6.0 * $author$project$Parameters$para.repr)),
					$elm$svg$Svg$Attributes$height(
					$elm$core$String$fromFloat(2.0 * $author$project$Parameters$para.repr))
				]),
			_List_Nil),
			A5($author$project$GameView$caption, ($author$project$Parameters$para.repx + (2.0 * $author$project$Parameters$para.repr)) - 33.0, $author$project$Parameters$para.repy + 3.0, 'white', 'Next Round', 20)
		]));
...
var $author$project$SvgSrc$myTile = F2(
	function (x1, x2) {
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromFloat(x1 - 15.0)),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromFloat(x2 - 17.3)),
					$elm$svg$Svg$Attributes$viewBox('0 0 30 34.6'),
					$elm$svg$Svg$Attributes$style('enable-background:new 0 0 30 34.6;'),
					$elm$svg$Svg$Attributes$width('30'),
					$elm$svg$Svg$Attributes$height('34.6')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$svg$Svg$text('.st0{fill:url(#SVGID_1_);}\n    .st1{fill:#006837;}\n    .st2{fill:none;}\n    .st3{fill:none;stroke:#000000;stroke-width:0.25;stroke-miterlimit:10;}\n')
						])),
					A2(
					$elm$svg$Svg$g,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$id('SVGID_1_'),
									$elm$svg$Svg$Attributes$cx('15'),
									$elm$svg$Svg$Attributes$cy('17.344'),
									$elm$svg$Svg$Attributes$r('16.0435'),
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$svg$Svg$Attributes$style('stop-color:#FFFFFF')
										]),
									_List_Nil),
									A2(
									$elm$svg$Svg$stop,
									_List_fromArray(
										[
											$elm$svg$Svg$Attributes$offset('0'),
											$elm$svg$Svg$Attributes$style('stop-color:#009245')
										]),
									_List_Nil),
									A2(
									$elm$svg$Svg$stop,
									_List_fromArray(
										[
											...
											$elm$svg$Svg$Attributes$style('stop-color:#006837')
										]),
									_List_Nil),
									A2(
									$elm$svg$Svg$stop,
									_List_fromArray(
										[
											$elm$svg$Svg$Attributes$offset('1'),
											$elm$svg$Svg$Attributes$style('stop-color:#000000')
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									$elm$svg$Svg$Attributes$points('0.1,25.9 0.1,8.8 15,0.2 29.9,8.8 29.9,25.9 15,34.5   ')
								]),
							_List_Nil),
							A2(
							$elm$svg$Svg$path,
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$d('M15,0.3l14.7,8.5l0,17L15,34.4L0.3,25.8v-17L15,0.3 M15,0L0,8.7V26l15,8.6L30,26l0-17.3L15,0L15,0z')
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$class('st2'),
							$elm$svg$Svg$Attributes$d('M-5.8,8.8c0,0.1-0.1,0.1-0.1,0.2')
						]),
					_List_Nil),
					A2(
					$elm$svg$Svg$g,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$class('st3'),
									$elm$svg$Svg$Attributes$d('M21.3,14.5c0.6,0.2,1,0.6,1.1,1.2c0,0.3-0.1,0.7-0.1,1.1c0,0.8,0.2,1.5,0.3,2.3c0,0,0-0.1,0-0.1')
								]),
							_List_Nil),
							A2(
							$elm$svg$Svg$path,
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$class('st3'),
									$elm$svg$Svg$Attributes$d('M23,14.3C23,14.3,23,14.3,23,14.3C23,14.3,23,14.3,23,14.3c-0.3,0.2-0.5,0.5-0.6,0.9')
								]),
							_List_Nil)
						]))
				]));
...
var $author$project$GameView$renderHex = F3(
...
var $author$project$GameView$renderTile = F2(
	function (theme, t) {
		var ind = t.indice;
		var t1 = ind.a;
		var t2 = ind.b;
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$stroke(borderStrokeColor),
							$elm$svg$Svg$Attributes$fillOpacity('0.0')
						]),
					_List_Nil)
				]));
		...
		var tiles = function () {
			switch (theme.$) {
				case 'Minimum':
					return A2(
						$elm$core$List$map,
						A2($author$project$GameView$renderHex, $author$project$Parameters$para.mtc, 1.0),
						A2(
							$elm$core$List$cons,
							_Utils_Tuple2(i, j),
							$author$project$Geometry$generateZone(
				...
				default:
					return A2(
						...
						function (_v10) {
							var u = _v10.a;
							var v = _v10.b;
							return A2($author$project$SvgSrc$myTile, u, v);
						},
						hexCoordinates);
			}
		}();
...
var $author$project$GameView$renderFilm = F2(
	function (model, _v0) {
		var i = _v0.a;
		var j = _v0.b;
		var a = $author$project$Parameters$para.a;
...
var $author$project$GameView$renderTileFilm = F2(
	function (model, t) {
		var ind = t.indice;
		var t1 = ind.a;
		var t2 = ind.b;
		...
		return A2(
			$elm$core$List$map,
			$author$project$GameView$renderFilm(model),
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(i, j),
				$author$project$Geometry$generateZone(
...
var $author$project$GameView$renderVirus = function (v) {
	var pos = v.pos;
	return A2(
		$elm$core$List$map,
		A2($author$project$GameView$renderHex, 'purple', 0.5),
		pos);
};
var $elm$core$Debug$toString = _Debug_toString;
var $author$project$GameView$renderVirusInf = function (vir) {
	var rule = A2(
		$elm$core$String$join,
		' or ',
		A2(
			...
			vir.rules));
	var infect = $elm$core$Debug$toString(vir.infect);
	var inf = (!_Utils_eq(vir.rules, _List_Nil)) ? A3(
		$elm$core$List$foldl,
		function (x) {
			return function (y) {
				return _Utils_ap(x, y);
	...
	return A2(
		...
		function (_v1) {
			...
			var y = _v1.b;
			var str = _v1.c;
			return A5($author$project$GameView$caption, x + 820.0, y, 'red', str, 12);
		},
		A2(
			$elm$core$List$map,
			function (_v0) {
			...
			A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, inf)));
};
var $author$project$GameView$renderantiVirus = function (av) {
	var pos = av.pos;
	return A2(
		$elm$core$List$map,
		A2($author$project$GameView$renderHex, 'blue', 0.5),
		pos);
};
	...
	var film = function () {
		...
		if (_v1.$ === 'SelHexOn') {
			return A3(
				...
				A2(
					$elm$core$List$map,
					$author$project$GameView$renderTileFilm(model),
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							_List_fromArray(
								[
									$author$project$View$bkg(model.theme)
								]),
							_Utils_ap(
								A3(
									$elm$core$List$foldl,
									...
									A2(
										$elm$core$List$map,
										$author$project$GameView$renderTile(model.theme),
										model.city.tilesIndex)),
								_Utils_ap(
									$author$project$GameView$renderVirus(model.virus),
									_Utils_ap(
										$author$project$GameView$renderantiVirus(model.av),
										_Utils_ap(
											_List_fromArray(
												[
											...
											_Utils_ap(
												$author$project$GameView$renderFlags(
													_List_fromArray(
														[5, 10, 15])),
												_Utils_ap(
													$author$project$GameView$renderHands(model),
													_Utils_ap(
														$author$project$GameView$renderConsole(model),
														_Utils_ap(
															$author$project$GameView$renderVirusInf(model.virus),
															_Utils_ap(
																_List_fromArray(
																	[$author$project$GameView$renderNextRound]),
																_Utils_ap(
																	_List_fromArray(
																		[
																	...
																	_Utils_ap(
																		_List_fromArray(
																			[
																				$author$project$GameView$renderEconomyProgress(model)
																			]),
																		_Utils_ap(
																			((_Utils_eq(
																				...
																				[$author$project$SvgSrc$hand2FirstCard]) : _List_Nil,
																			_Utils_ap(
																				(A2(
																					$elm$core$List$member,
																					$author$project$Model$lr(model),
																				...
																				_Utils_ap(
																					...
																					film)))))))))))))))),
						$author$project$GameView$nextRoundButton(model),
						$elm$html$Html$text(
						...
						$elm$html$Html$text(
						'economy: ' + $elm$core$String$fromInt(model.economy))
					]));
		case 'Drawing':
			return A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							_Utils_ap(
								$author$project$GameView$renderInitCards(model),
								_Utils_ap(
									_List_fromArray(
										[
											A5($author$project$GameView$caption, 20, 200, 'white', 'click on card to replace', 20)
										]),
									_List_fromArray(
										[
											A5(
						...
						_List_fromArray(
							[
								$author$project$GameView$onClick($author$project$Message$StartRound1)
							]),
						_List_fromArray(
							[
