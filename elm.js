...
var $author$project$Virus$initVirus = {
	infect: 1,
	kill: 0.1,
	number: 0,
	pos: _List_fromArray(
	...
	return _Utils_Tuple2(
		{
			...
			virus: $author$project$Virus$initVirus,
			warehouseNum: 0
		},
...
var $author$project$Population$populationFlow = F2(
	function (n, city) {
		populationFlow:
		while (true) {
...
var $author$project$Population$updateCity = F2(
	function (city, vir) {
		return A2(
...
var $author$project$Update$virusEvolve = function (model) {
	return _Utils_update(
		model,
		{
			...
			city: A2($author$project$Population$updateCity, model.city, model.virus),
...
var $author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'PlayCard':
				var card = msg.a;
				return ((_Utils_cmp(card.cost, model.power) < 1) && (_Utils_cmp($author$project$Parameters$para.ecoThreshold, model.economy) < 1)) ? (A2($elm$core$List$member, card, $author$project$Card$targetCardlst) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var $author$project$GameView$cardButton = function (card) {
	return A2(
...
var $author$project$GameView$evolveButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$author$project$GameView$onClick($author$project$Message$VirusEvolve)
		]),
	_List_fromArray(
		[
...
var $author$project$GameView$nextRoundButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
...
var $author$project$GameView$powerEcoInfo = function (model) {
...
var $author$project$GameView$renderCard = F4(
	function (n, x, y, c) {
		return A2(
			$elm$svg$Svg$svg,
			_List_Nil,
...
var $author$project$GameView$renderCardFilm = F5(
	...
	return _Utils_ap(
		A2(
			...
			function (_v0) {
				...
				var y = _v1.b;
				var c = _v0.c;
				return A4($author$project$GameView$renderCard, n, x, y, c);
			},
			indexed),
		A2(
			$elm$core$List$map,
			function (_v2) {
				...
				var y = _v3.b;
				var c = _v2.c;
				return A5($author$project$GameView$renderCardFilm, n, x, y, c, model);
			},
			indexed));
};
...
var $author$project$GameView$renderTile = function (t) {
	var ind = t.indice;
	var t1 = ind.a;
	var t2 = ind.b;
	var j = t1 + (3 * t2);
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							_Utils_ap(
								A3(
									...
									_List_Nil,
									A2($elm$core$List$map, $author$project$GameView$renderTile, model.city.tilesindex)),
								_Utils_ap(
										...
										_Utils_ap(
											...
											_Utils_ap(
												...
												_Utils_ap(
													...
													_List_fromArray(
														[
															A5($author$project$GameView$caption, 15, 70, 'green', 'green: healthy population', 15),
															A5($author$project$GameView$caption, 15, 90, 'orange', 'orange: infected population', 15),
															A5($author$project$GameView$caption, 15, 110, 'red', 'red: dead population', 15),
															A5($author$project$GameView$caption, 15, 130, 'purple', 'purple hex: Virus', 15),
															A5($author$project$GameView$caption, 15, 150, 'blue', 'blue hex: AntiVirus', 15)
														]))))))))),
						$author$project$GameView$evolveButton,
						$author$project$GameView$nextRoundButton,
						$elm$html$Html$text(
						...
						$author$project$GameView$powerEcoInfo(model),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						A2($elm$core$List$map, $author$project$GameView$cardButton, $author$project$Card$allCards)),
						$elm$html$Html$text(
						_Utils_ap(
