    ...
    case model.state of
        Playing ->
            div [ HA.style "background-color" "#FFF" ]
                ...
                , Html.text ("sumPopulation: " ++ Debug.toString (sumPopulation model.city) ++ ". Dead : " ++ Debug.toString (sumDead model.city) ++". Sick : " ++ Debug.toString (sumSick model.city))
                ...
                , Html.text ("economy: " ++ String.fromInt model.economy ++ ". Level : " ++ Debug.toString model.currentLevel)
                ]
